...
The three plots show visualisations of travel time (in minutes) using the viridis colour palette.
...
Just a note that these datasets use population density per pixel as their unit of measurement.
