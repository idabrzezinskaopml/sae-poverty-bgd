...
The command for creating the maps of direct estimates vs FH estimates are almost identical. To create the visualisation for the direct estimates you use the argument "fill = Direct", as opposed to "fill = FH" for the FH estimates.
