...
library("devtools")       # User-developed packages
library("cividis")        # Another colour palette
...
pal2 \<- leaflet::colorNumeric(cividis_pal(option = "C")(2), domain = values(fblist.processed\[\[1\]\]), na.color = "transparent")
