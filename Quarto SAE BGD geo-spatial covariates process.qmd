...
-   Covers areas that would otherwise be difficult to access, such as mountain ranges, islands, and remote communities.
...
![](images/geographic-coordinate-system-l-01.jpg){width="433"}
:::
...
Need to assign the upazila code to the final data frame
...
# Compare values to those obtained by Nikos (and my earlier estimates)
# Get column names
colnames(upazila)
colnames(final.cov.est)
colnames(zonal.stats.all)

# Summary - min of Global Travel Time to Cities - reasonably similar
...
# Max distance to the closest road - super similar!
...
# Sum population density of women - super similar again!
